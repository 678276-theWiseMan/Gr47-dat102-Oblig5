...
public interface SoektreADT <T extends Comparable<? super T>> {
	...
	/**
	 * Legg eit element til treet dersom det ikkje finst frå før. Det betyr
	 * at a.compareTo(b) != 0. Elles blir det gamle elementet erstatta med det nye.
	 * 
